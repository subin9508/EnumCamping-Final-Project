...
// 각 이미지와 모달 창 요소를 가져옵니다.
    ...
    var storeImg = document.getElementById('storeImage');
    ...
    var modalImg6 = document.getElementById('modalImage6');
   ...
   sinkImg.onclick = function() {
    ...
    campFireImage.onclick = function() {
        modal5.style.display = "block";
        modalImg5.src = this.src;
    }
    storeImage.onclick = function() {
